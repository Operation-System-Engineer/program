...
extern initialize_file_ftype _initialize_i386_linux_tdep;
...
extern initialize_file_ftype _initialize_gdbtk;
extern initialize_file_ftype _initialize_gdbtk_interp;
