...
# build directory.
ITCL_BUILD_LIB_SPEC='-L/home/liusichao/insight-6.8-1/itcl/itcl -litcl3.2${TCL_DBGX}'
...
# build directory.
ITCL_BUILD_STUB_LIB_SPEC='-L/home/liusichao/insight-6.8-1/itcl/itcl -litclstub3.2${TCL_DBGX}'
...
ITCL_SRC_DIR='/home/liusichao/insight-6.8-1/itcl/itcl'
